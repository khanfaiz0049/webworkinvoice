<x-app-layout>
    ...
    <div class="bg-white rounded-2xl sm:rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden w-full">
        <div class="px-4 sm:px-6 lg:px-10 py-6 sm:py-8 border-b border-slate-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-50/50 w-full">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-4 w-full sm:w-auto">
                <form method="GET" action="{{ route('invoices.index') }}" class="flex items-center justify-between sm:justify-start gap-2 bg-white border border-slate-200 hover:border-slate-300 rounded-xl px-3 py-1.5 shadow-sm transition-colors w-full sm:w-auto">
                ...
                <a href="{{ route('invoices.create') }}" class="w-full sm:w-auto bg-[#d32d27] hover:bg-[#b21f24] text-white font-black py-3 px-8 rounded-xl transition-all duration-200 shadow-lg shadow-red-500/20 active:scale-95 text-xs uppercase tracking-widest flex items-center justify-center gap-2">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] bg-white">
                        ...
                        <th class="px-4 sm:px-6 py-6">Status</th>
